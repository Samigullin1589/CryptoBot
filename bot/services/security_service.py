...
Кратко: Исправлен SyntaxError из-за вставленной текстовой шапки. Ниже только чистый Python код без декоративных строк. Добавлен универсальный вызов AI с поддержкой обеих сигнатур, усилены эвристики и логирование.
