...
Кратко: Уберите декоративные строки-шапку при сохранении файла .py. Ниже — полный рабочий код без посторонних символов. Исправлен вызов AI (поддержка обеих сигнатур), усилены эвристики и логирование.
