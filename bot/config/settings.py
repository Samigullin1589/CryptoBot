...
class AppSettings(BaseSettings):
    ...
    # Обновленный путь к API Индекса Страха и Жадности от CoinMarketCap
    ...
    # --- Настройки новостей ---
    # Объединенный и обновленный список RSS-лент
    ...
    # --- Настройки криптовалют и майнинга ---
    ...
    # --- Аварийные (fallback) данные по ASIC-майнерам ---
    # Используются, если основные API недоступны
