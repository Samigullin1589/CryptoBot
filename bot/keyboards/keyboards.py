...
def get_main_menu_keyboard() -> InlineKeyboardMarkup:
    """Создает клавиатуру главного меню с использованием фабрики. МАЙНИНГ НА ПЕРВОМ МЕСТЕ."""
    builder = InlineKeyboardBuilder()

    # ========== ПЕРВЫЙ ПРИОРИТЕТ: МАЙНИНГ ==========
    builder.button(
    ...
    # ========== ВТОРОЙ ПРИОРИТЕТ: ЦЕНЫ И ДАННЫЕ ==========
    builder.button(
        text="💹 Курс",
    ...
    # ========== ЧЕТВЕРТЫЙ ПРИОРИТЕТ: ДОПОЛНИТЕЛЬНО ==========
    builder.button(
        text="😱 Индекс Страха",
