...
def generate_fng_image(value: int, classification: str) -> bytes:
    ...
    try:
        ...
        fig.text(0.5, 0.5, f"{value}", ha='center', va='center', fontsize=VALUE_FONT_SIZE, color=FONT_COLOR, weight='bold')
        fig.text(0.5, 0.35, classification, ha='center', va='center', fontsize=CLASSIFICATION_FONT_SIZE, color=FONT_COLOR)
